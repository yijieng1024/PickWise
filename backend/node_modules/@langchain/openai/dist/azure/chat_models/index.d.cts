import { AzureOpenAIChatInput } from "../../types.cjs";
import { ChatOpenAI, ChatOpenAICallOptions } from "../../chat_models/index.cjs";
 ...
 * </details>
 */
declare class AzureChatOpenAI<CallOptions extends ChatOpenAICallOptions = ChatOpenAICallOptions> extends ChatOpenAI<CallOptions> implements Partial<AzureOpenAIChatInput> {
